...
function focusInput (input, dataLength) {
    ...
    let currrentInput = input
    while(addedChars > 4 && currrentInput.nextElementSibling != null ) {
        addedChars -= 4
        currrentInput = currrentInput.nextElementSibling
    }
    if(addedChars > 4) addedChars = 4

    currrentInput.focus()
    currrentInput.selectionStart = addedChars
    currrentInput.selectionEnd = addedChars
}
